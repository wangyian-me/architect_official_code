...
for j in range(args.l, args.r):
    ...
    # furniture_to_place, kind, prompts = find_large(all_large_path, prompt_list[j])
    ...
    # furniture_to_place = ["coffee table-0"]
    # kind = ["table"]
    # prompts = ['An organized wooden coffee table full of objects.']
