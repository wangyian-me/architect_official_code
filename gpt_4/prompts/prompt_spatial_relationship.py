...
def query_spatial_relationship(task_name, task_description, involved_objects, articulation_tree, semantics, links,
                               joints, substeps, save_path=None,
...
substeps:
{}
""".format(task_name, task_description, involved_objects, articulation_tree, semantics, links, joints,
           "".join(substeps))
    ...
    if save_path is None:
        save_path = 'data/debug/{}_joint_angle.json'.format(task_name.replace(" ", "_"))

    system = "You are a helpful assistant."
    response = query(system, new_user_contents, assistant_contents, save_path=save_path, temperature=temperature,
                     model=model)
...
def query_spatial_relationship_rigid(task_name, involved_objects, substeps, save_path=None, temperature=0.1,
                                     model='gpt-4'):
    input = """
Task Name: {}
Objects involved: {}
