...
def genesis_room(args):
    ...
    for obj_info in scene_dict["wall_objects"]:
        ...
        if data[assetId]["front_view_rotation"][0] != 0 or data[assetId]["front_view_rotation"][2] != 0:
            # codimension
            rotation_offset = data[assetId]["front_view_rotation"]
    ...
    cam_0 = scene.add_camera(
        pos=(room_center[0], room_center[1], 6.0),
