...
from DepthLab import infer_func
...
def get_bbox(image_dir, output_dir, tags, descriptions, on_floors, camera_pose=None, intrinsic_K=None, max_depth=None,
    ...
    pipe_out = infer_func.inference(image_dir, mask_path, depth_path)
    depth_pred = pipe_out.depth_np
    pipe_out.depth_colored.save(os.path.join(output_dir, 'depth_color.jpg'))
